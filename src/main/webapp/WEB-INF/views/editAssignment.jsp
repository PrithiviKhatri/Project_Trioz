...
<body>
	<section class="container">
		<spring:url value="/assignment/saveUpdate" var="save"></spring:url>
		<form:form modelAttribute="updateAssignment" action="${save}" class="form-horizontal" method="POST">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="submissionDate"><spring:message code="addAssignment.form.submissionDate.label"/></label>
					<div class="col-lg-10">
						<form:input id="submissionDate" path="submissionDate" type="text"/>
						<form:errors path="submissionDate" cssClass="text-danger"/>
					</div>
				</div>
				<div class="form-group">
